                    ...
                    {Object.keys(ownershipInfo).map((key) => {
                        ...
                        return (
                            <div style={{ padding: "10px" }}>
                                <div style={{ backgroundColor: "#fe7a51", borderRadius: "100%", width: "18px", height: "18px", display: "inline-block", position: "relative", left: "-9px", top: "4px" }}></div>
                                <CardSubHeader style={{ color: "rgba(0, 0, 0, 0.87)", fontSize: "14px", fontWeight: "500", lineHeight: "17px", textAlign: "left", display: "inline-block", paddingTop: "10px" }}> {t("PT_DATE_OF_TRANSFER")} </CardSubHeader>
                                <CardSubHeader style={{ color: "rgba(0, 0, 0, 0.87)", fontSize: "14px", fontWeight: "500", lineHeight: "17px", textAlign: "left", display: "inline-block", paddingTop: "10px" }}>&nbsp;-&nbsp;{date}</CardSubHeader>
